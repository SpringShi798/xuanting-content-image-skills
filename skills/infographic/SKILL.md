...
metadata:
  openclaw:
    homepage: https://github.com/JimLiu/baoyu-skills#infographic
---
...
- If `usage: direct` AND the chosen backend accepts reference images (e.g., `imagine` via `--ref`) → pass the file via the backend's ref parameter
