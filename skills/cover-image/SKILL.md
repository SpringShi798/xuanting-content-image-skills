...
metadata:
  openclaw:
    homepage: https://github.com/JimLiu/baoyu-skills#cover-image
---
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure cover-image preferences" / "重新配置"). The next run re-triggers first-time setup.
