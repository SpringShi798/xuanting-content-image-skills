...
metadata:
  openclaw:
    homepage: https://github.com/JimLiu/baoyu-skills#article-illustrator
---
...
- **Reconfigure interactively** — delete EXTEND.md (or ask "reconfigure article-illustrator preferences" / "重新配置"). The next run re-triggers first-time setup.
